...
class EpisodeController extends Controller
{
    ...
    public function store(TvShow $tvShow, Season $season)
    {
        ...
        if ($tmdb_episode->successful())
        {
            ...
            return Redirect::back()->with('flash.banner', 'Episode Created Success');
        }else{
    ...
    {
        $episode->delete();
        return Redirect::route('admin.episodes.index', [$tvShow->id, $season->id])->with('flash.banner', 'Episode Deleted.');
    }
}
