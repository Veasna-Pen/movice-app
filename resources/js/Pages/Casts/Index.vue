            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Cast</a>
                    </div>
                </li>
            </ol>
        </nav>
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                        <div class="flex justify-between items-center p-4">
                            ...
                            <div class="flex">
                                <div>
                                    <form>
                                        <div class="relative">
                                            <input v-model="castTMDBId" id="default-search"
                                ...
                                <div>
                                    <select v-model="perPage" @change="getCasts" id="countries"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr v-for="cast in casts.data" :key="cast.id"
                                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="py-4 px-6">{{ cast.id }}</td>
                                    <td class="py-4 px-6">
                                        {{ cast.name }}
                                    </td>
                                    <td class="py-4 px-6">
                                    ...
                                    <td class="flex py-4 px-6">
                                        ...
                                        <Link :href="route('admin.casts.destroy', cast.id)" method="delete" as="button" type="button">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
