            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Movie
                            </a>
                    </div>
                </li>
            </ol>
                        ...
                        <div class="flex justify-between items-center p-4">
                            ...
                            <div class="flex">
                                <div>
                                    <form>
                                        <div class="relative">
                                            <input v-model="movieTMDBId" id="default-search"
                                ...
                                <div>
                                    <select v-model="perPage" @change="getMovies" id="countries"
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <tr v-for="movie in movies.data" :key="movie.id"
                                    ...
                                    <td class="py-4 px-6">{{ movie.id }}</td>
                                    <td class="py-4 px-6">
                                        {{ movie.title }}
                                    </td>
                                    <td class="py-4 px-6">
                                    ...
                                    <td class="flex py-4 px-6">
                                        ...
                                        <Link :href="route('admin.movies.edit', movie.id)">
                                        ...
                                        <Link :href="route('admin.movies.destroy', movie.id)" method="delete"
...
function generateMovie() {
    Inertia.post(
        "/admin/movies",
        { movieMDBId: movieMDBId.value },
        {
            onFinish: () => (movieMDBId.value = ""),
        }
    );
}
