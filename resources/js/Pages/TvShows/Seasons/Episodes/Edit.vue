<template>
    <admin-layout title="Update Episode">
        <!-- Breadcrumb -->
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="#"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Season
                        </a>
                    </div>
                </li>
                <li>
            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg p-4">
                        <form @submit.prevent="updateEpisode" class="p-4">
                            <div>
                            ...
                            <div>
                                ...
                                <TextInput id="overview" type="text" class="mt-1 block w-full" v-model="form.overview" autofocus
                                    autocomplete="overview" />
                                <InputError class="mt-2" :message="$page.props.errors.overview" />
                            </div>

                            <div>
                                <InputLabel for="is_public" value="Is Public" />
                                <Checkbox id="is_public" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" v-model="form.is_public" autofocus
                                    autocomplete="is_public" />
                                <span class="ml-2 text-sm text-gray-600">Public</span>
                                <InputError class="mt-2" :message="$page.props.errors.is_public" />
                            </div>
